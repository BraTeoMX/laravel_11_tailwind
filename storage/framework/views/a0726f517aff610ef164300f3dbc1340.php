<?php $__env->startSection('content'); ?>
    <div class="mb-0 w-screen lg:w-[500px] card shadow-lg border-none shadow-slate-100 relative">
        <div class="!px-10 !py-12 card-body">
            ...
            <form action="<?php echo e(route('register')); ?>" class="mt-10" method="POST">
                <?php echo csrf_field(); ?>
                <div class="mb-3">
                ...
                <div class="mt-10 text-center">
                    <p class="mb-0 text-slate-500 dark:text-zink-200">Already have an account ?
                        <a href="<?php echo e(route('login')); ?>" class="font-semibold underline transition-all duration-150 ease-linear text-slate-500 dark:text-zink-200 hover:text-custom-500 dark:hover:text-custom-500">Login</a>
                    </p>
                </div>
            </form>
        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp8\htdocs\sistema_laboratorio\resources\views/auth/register.blade.php ENDPATH**/ ?>